...
@section('body')
   ...
   <main class="rivo-content">
        <div class="rivo-page-header">
          ...
          <div class="rivo-breadcrumb"><a href="index.html">Dashboard</a> / <a href="products.html">Products</a> / Edit the {{$product->name}}</div>
        </div>

        <div class="alert alert-success rivo-form-success" style="display:none;" role="alert">
          <i class="bi bi-check-circle me-2"></i>{{$product->name}} update successfully! (Demo)
        </div>
          ...
          <form action="{{route('product.update' , $product->id)}}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="row g-4">
              <div class="col-lg-4">
                ...
                <input value="" type="file" class="d-none" name="img[]" multiple >
              ...
              <div class="col-lg-8">
                <div class="rivo-form-group">
                  ...
                  <div class="rivo-input-wrap">
                    <input value="{{old('name' , $product->name)}}" type="text" class="form-control" name="name" >
                  </div>
                </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-4">
                    <div class="rivo-form-group">
                      ...
                      <div class="rivo-input-wrap">
                        <input value="{{old('price' , $product->price)}}" type="number" class="form-control" name="price">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="rivo-form-group">
                      ...
                      <div class="rivo-input-wrap">
                        <input value="{{old('sale' , $product->sale)}}" type="number" class="form-control" name="sale" >
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="rivo-form-group">
                      ...
                      <div class="rivo-input-wrap">
                        ...
                        <input value="{{old('count' , $product->count)}}" type="number" class="form-control" name="count" >
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="rivo-form-group mb-0">
                      ...
                      <label>Brand</label>
                      <div class="rivo-input-wrap">
                        <input  value="{{old('brand' , $product->brand)}}" type="text" class="form-control" name="brand" >
                      </div>
                    </div>
                  </div>
                </div>
