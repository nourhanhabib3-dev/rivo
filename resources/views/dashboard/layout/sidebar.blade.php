        ...
        <ul class="rivo-nav__list">
          <li class="rivo-nav__item">
            <a href="index.html" class="rivo-nav__link active">
              ...
              <span class="rivo-nav__text">Dashboard</span>
            </a>
          </li>
          <li class="rivo-nav__item">
            <a href="users.html" class="rivo-nav__link">
              <i class="bi bi-people-fill"></i>
              <span class="rivo-nav__text">Users</span>
            </a>
          </li>
          <li class="rivo-nav__item">
            <a href="{{route('cat.index')}}" class="rivo-nav__link">
              <i class="bi bi-box-seam-fill"></i>
              <span class="rivo-nav__text">Category</span>
            </a>
          </li>
          <li class="rivo-nav__item">
            <a href="{{route('product.index')}}" class="rivo-nav__link">
              <i class="bi bi-box-seam-fill"></i>
              <span class="rivo-nav__text">Products</span>
            </a>
          </li>
          <li class="rivo-nav__item">
            <a href="{{route('admin.index')}}" class="rivo-nav__link">
